...
ct_model_path = os.path.join("datasets/opus_%s-%s" % (from_code, to_code))
sp_model_path = os.path.join("datasets/opus_%s-%s/source.spm" % (from_code, to_code))
tp_model_path = os.path.join("datasets/opus_%s-%s/target.spm" % (from_code, to_code))
...
translation_obj = translator.translate_batch(
    encode(src_text, sp),
